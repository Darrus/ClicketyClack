...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public class HandDraggablePluck : MonoBehaviour,
                                 IFocusable,
                                 IInputHandler,
                                 ISourceStateHandler
    {
        ...
        private Animator myAnimator; // Used to trigger tear animation in animator
        ...
        private void UpdateDragging()
        {
            ...
            if (!isPlucked)
            {
                if (currenthandDistance > pluckDistance)
                {
                    isPlucked = true;
